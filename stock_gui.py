...
class stock_predict_DL:
    ...
    def Mlp_model(self):
        ...
        regr = MLPRegressor(hidden_layer_sizes = 200, alpha = 0.01,solver = 'lbfgs',shuffle=True)
    ...
    def basic_ann_model(self):
        ...
        classifier.add(Dense(units = 64, activation = 'relu', input_dim = self.X_train.shape[1]))
